...
public enum BuildingType {
    ...
    WOOD_MINE(new Cost(10, 10, 10, 0, 0, 0, 0, Duration.ofSeconds(1)),7, 7),
    IRON_MINE(new Cost(10, 10, 10, 0, 0, 0, 0, Duration.ofSeconds(1)),7, 7),
    STONE_MINE(new Cost(10, 10, 10, 0, 0, 0, 0, Duration.ofSeconds(1)),7, 7),
    DIRTY_WATER_MINE(new Cost(10, 10, 10, 0, 0, 0, 0, Duration.ofSeconds(1)),7, 7),
    DIRTY_SOIL_MINE(new Cost(10, 10, 10, 0, 0, 0, 0, Duration.ofSeconds(1)),7, 7),
    ...
    SENTINEL_DEFENSIVE(new Cost(10, 10, 10, 10,10,10,10, Duration.ofSeconds(2)),6, 6),
    ...
    ARMY_PRODUCER(new Cost(10, 10, 10, 10,10,10,10, Duration.ofSeconds(2)),9, 9),
