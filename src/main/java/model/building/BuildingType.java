...
//REFINERY(new Cost(10, 10, 10, 0, 0, 0, 0, Duration.ofSeconds(1)),1, 1),
    ...
    WOOD_STORAGE(new Cost(250, 150, 100, 0, 0, 0, 0, Duration.ofSeconds(1)), 7, 7),
    IRON_STORAGE(new Cost(300, 200, 150, 0, 0, 0, 0, Duration.ofSeconds(1)), 7, 7),
    STONE_STORAGE(new Cost(250, 150, 100, 0, 0, 0, 0, Duration.ofSeconds(1)), 7, 7),
    WATER_STORAGE(new Cost(200, 120, 80, 0, 0, 0, 0, Duration.ofSeconds(1)), 7, 7),
    SOIL_STORAGE(new Cost(200, 120, 80, 0, 0, 0, 0, Duration.ofSeconds(1)), 7, 7),
    GUNPOWDER_STORAGE(new Cost(350, 250, 200, 0, 0, 0, 0, Duration.ofSeconds(1)), 7, 7),
