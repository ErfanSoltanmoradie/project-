...
public class TradeOffer {
    ...
    public TradeOffer(Village sender, Village receiver, Player alliancesender, Player alliancesreceiver, Map<ResourcesType , Integer> offeredResources, Map<ResourcesType , Integer> requestedResources) {
